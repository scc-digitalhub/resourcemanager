...
@Component
public class WebhookS3Builder implements ConsumerBuilder {
    ...
    public String getType() {
        return WebhookS3Consumer.TYPE;
    }

    @Override
    public String getId() {
        return WebhookS3Consumer.ID;
    }
    ...
    public Consumer build(Map<String, Serializable> properties) throws NoSuchConsumerException {
        ...
        WebhookS3Consumer consumer = new WebhookS3Consumer(properties);
    ...
    public Consumer build(Registration reg) throws NoSuchConsumerException {
        // properties supported
        WebhookS3Consumer consumer = new WebhookS3Consumer(reg);
        // explicitly call init() since @postconstruct won't work here
        consumer.init();
