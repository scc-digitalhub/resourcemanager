...
public class DremioSqlConsumer extends Consumer {

    private final static Logger _log = LoggerFactory.getLogger(DremioSqlConsumer.class);

    public static final String TYPE = SystemKeys.TYPE_SQL;
    public static final String ID = "dremiosql";
    ...
    public DremioSqlConsumer(Map<String, Serializable> properties) {
        this();
        _properties = properties;
    }

    public DremioSqlConsumer(Registration reg) {
        this();
        registration = reg;
